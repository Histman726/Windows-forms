...
namespace CRUD_Dataset__Dataprovider__Entity_Framework {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class PersonasDataTable : global::System.Data.TypedTableBase<PersonasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonasRow AddPersonasRow(string name, int age) {
        ...
        public partial class PersonasRow : global::System.Data.DataRow {
            ...
            public string name {
                get {
                    try {
                        return ((string)(this[this.tablePersonas.nameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'name\' de la tabla \'Personas\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tablePersonas.nameColumn] = value;
                }
            }
            ...
            public int age {
                get {
                    try {
                        return ((int)(this[this.tablePersonas.ageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'age\' de la tabla \'Personas\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tablePersonas.ageColumn] = value;
                }
            }
            ...
            public bool IsnameNull() {
                return this.IsNull(this.tablePersonas.nameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetnameNull() {
                this[this.tablePersonas.nameColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsageNull() {
                return this.IsNull(this.tablePersonas.ageColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetageNull() {
                this[this.tablePersonas.ageColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace CRUD_Dataset__Dataprovider__Entity_Framework.DataSet1TableAdapters {
    ...
    public partial class PersonasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Personas] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [n" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Personas] ([name], [age]) VALUES (@name, @age);\r\nSELECT id, name, ag" +
                "e FROM Personas WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Personas] SET [name] = @name, [age] = @age WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)));
SELECT id, name, age FROM Personas WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_Dataset__Dataprovider__Entity_Framework.Properties.Settings.Default.CRUDWFConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "select * from Personas";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "insert into Personas(name,age) values (@name,@age)";
            ...
            this._commandCollection[2].CommandText = "Update Personas set \r\nname=@name,\r\nage=@age\r\nwhere id=@id";
            ...
            this._commandCollection[3].CommandText = "select * from Personas \r\nwhere id=@id";
            ...
            this._commandCollection[4].CommandText = "Delete from Personas \r\nwhere id=@id";
        ...
        public virtual DataSet1.PersonasDataTable GetDataByID(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            DataSet1.PersonasDataTable dataTable = new DataSet1.PersonasDataTable();
            this.Adapter.Fill(dataTable);
