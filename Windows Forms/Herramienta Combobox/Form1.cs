...
namespace Herramienta_Combobox
{
    public partial class Form1 : Form
    {
        ...
        {
            if (!cmbAlimentos.Items.Contains(txtAlimentos.Text))
                cmbAlimentos.Items.Add(txtAlimentos.Text);
            else
                MessageBox.Show("El elemento " + txtAlimentos.Text + " ya existe",null,MessageBoxButtons.OK,MessageBoxIcon.Warning);
        }
